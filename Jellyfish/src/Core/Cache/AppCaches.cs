...
public abstract class AppCaches
{
    ...
    /// </summary>
    public static readonly ConcurrentDictionary<string, HashSet<uint>> Permissions = new();

    /// <summary>
    ///     Team Play Configuration Cache, GuildId_ConfigName as key, config object(without tracking) as value
    /// </summary>
    public static readonly ConcurrentDictionary<string, TpConfig> TeamPlayConfigs = new();
}
