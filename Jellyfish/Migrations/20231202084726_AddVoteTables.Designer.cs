...
namespace Jellyfish.Migrations
{
    ...
    [Migration("20231202084726_AddVoteTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jellyfish.Module.Vote.Data.Vote", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Jellyfish.Module.Vote.Data.VoteChannel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool>("EnableFree")
                        .HasColumnType("boolean")
                        .HasColumnName("enable_free");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_vote_channels");

                    b.HasIndex("VoteId")
                        .HasDatabaseName("ix_vote_channels_vote_id");

                    b.ToTable("vote_channels", (string)null);
                });

            modelBuilder.Entity("Jellyfish.Module.Vote.Data.VoteOption", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("VoteChannelId")
                        .HasColumnType("bigint")
                        .HasColumnName("vote_channel_id");
                    ...
                    b.HasIndex("VoteChannelId")
                        .HasDatabaseName("ix_vote_options_vote_channel_id");

                    b.HasIndex("VoteId")
                        .HasDatabaseName("ix_vote_options_vote_id");
            ...
            modelBuilder.Entity("Jellyfish.Module.Vote.Data.VoteChannel", b =>
                {
                    b.HasOne("Jellyfish.Module.Vote.Data.Vote", "Config")
                        .WithMany("Channels")
                        .HasForeignKey("VoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_vote_channels_votes_vote_id");
            ...
            modelBuilder.Entity("Jellyfish.Module.Vote.Data.VoteOption", b =>
                {
                    b.HasOne("Jellyfish.Module.Vote.Data.VoteChannel", "CreationChannel")
                        .WithMany("Options")
                        .HasForeignKey("VoteChannelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_vote_options_vote_channels_vote_channel_id");
                    ...
                    b.HasOne("Jellyfish.Module.Vote.Data.Vote", "Config")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_vote_options_votes_vote_id");

                    b.Navigation("Config");

                    b.Navigation("CreationChannel");
                });
