...
namespace Jellyfish.Migrations
{
    ...
    [Migration("20231213124321_AddClockInAndUserActivityTables")]
    partial class AddClockInAndUserActivityTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "activity_score_action", new[] { "add", "minus", "set_to" });
            ...
            modelBuilder.Entity("Jellyfish.Module.UserActivity.Data.UserActivity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("TotalClockInDay")
                        .HasColumnType("bigint")
                        .HasColumnName("total_clock_in_day");
            ...
            modelBuilder.Entity("Jellyfish.Module.UserActivity.Data.UserActivityHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<ActivityScoreAction>("Action")
                        .HasColumnType("activity_score_action")
