...
namespace Jellyfish.Migrations
{
    ...
    [Migration("20250531102236_AddRecallMessageTable")]
    partial class AddRecallMessageTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "channel_type", new[] { "unspecified", "category", "text", "voice", "dm", "thread" });
            ...
            modelBuilder.Entity("Jellyfish.Module.Push.Weibo.Data.WeiboCrawlHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_weibo_crawl_histories");

                    b.ToTable("weibo_crawl_histories", (string)null);
                });

            modelBuilder.Entity("Jellyfish.Module.Push.Weibo.Data.WeiboPushConfig", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_weibo_push_configs");

                    b.HasIndex("Alias", "GuildId")
                        .IsUnique()
                        .HasDatabaseName("ix_weibo_push_configs_alias_guild_id");

                    b.HasIndex("Uid", "GuildId")
                        .IsUnique()
                        .HasDatabaseName("ix_weibo_push_configs_uid_guild_id");

                    b.ToTable("weibo_push_configs", (string)null);
                });

            modelBuilder.Entity("Jellyfish.Module.Push.Weibo.Data.WeiboPushHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_weibo_push_histories");

                    b.HasIndex("InstanceId")
                        .HasDatabaseName("ix_weibo_push_histories_instance_id");

                    b.ToTable("weibo_push_histories", (string)null);
                });

            modelBuilder.Entity("Jellyfish.Module.Push.Weibo.Data.WeiboPushInstance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_weibo_push_instances");

                    b.HasIndex("ConfigId", "ChannelId")
                        .IsUnique()
                        .HasDatabaseName("ix_weibo_push_instances_config_id_channel_id");

                    b.ToTable("weibo_push_instances", (string)null);
                });

            modelBuilder.Entity("Jellyfish.Module.RecallMessageMonitor.Data.RecallMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_recall_messages");

                    b.ToTable("recall_messages", (string)null);
                });
            ...
            modelBuilder.Entity("Jellyfish.Module.TeamPlay.Data.TpConfig", b =>
                {
                    ...
                    b.Property<bool>("EnableTmpTextChannel")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("enable_tmp_text_channel");
            ...
            modelBuilder.Entity("Jellyfish.Module.Push.Weibo.Data.WeiboPushHistory", b =>
                {
                    b.HasOne("Jellyfish.Module.Push.Weibo.Data.WeiboPushInstance", "Instance")
                        .WithMany("PushHistories")
                        .HasForeignKey("InstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_weibo_push_histories_weibo_push_instances_instance_id");
            ...
            modelBuilder.Entity("Jellyfish.Module.Push.Weibo.Data.WeiboPushInstance", b =>
                {
                    b.HasOne("Jellyfish.Module.Push.Weibo.Data.WeiboPushConfig", "Config")
                        .WithMany("Instances")
                        .HasForeignKey("ConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_weibo_push_instances_weibo_push_configs_config_id");
