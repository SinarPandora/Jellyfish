...
namespace Jellyfish.Migrations
{
    ...
    [Migration("20231209175049_AddGuildSettingTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jellyfish.Custom.GuildSetting.Data.GuildSetting", b =>
                {
                    b.OwnsOne("Jellyfish.Custom.GuildSetting.Data.GuildSettingDetails", "Setting", b1 =>
                        {
                            b1.Property<long>("GuildSettingId")
                                .HasColumnType("bigint")
                                .HasColumnName("id");

                            b1.Property<decimal[]>("DefaultManagerAccounts")
                                .IsRequired()
                                .HasColumnType("numeric(20,0)[]")
                                .HasColumnName("setting_default_manager_accounts");

                            b1.Property<decimal[]>("DefaultManagerRoles")
                                .IsRequired()
                                .HasColumnType("numeric(20,0)[]")
                                .HasColumnName("setting_default_manager_roles");

                            b1.Property<HashSet<GuildCustomFeature>>("EnabledFeatures")
                                .IsRequired()
                                .HasColumnType("guild_custom_feature[]")
                                .HasColumnName("setting_enabled_features");

                            b1.Property<decimal[]>("SynergyBotAccounts")
                                .IsRequired()
                                .HasColumnType("numeric(20,0)[]")
                                .HasColumnName("setting_synergy_bot_accounts");

                            b1.HasKey("GuildSettingId");

                            b1.ToTable("guild_settings");

                            b1.ToJson("Setting");

                            b1.WithOwner()
                                .HasForeignKey("GuildSettingId")
                                .HasConstraintName("fk_guild_settings_guild_settings_id");
                        });
